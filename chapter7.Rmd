...
- Use the [`table()`](http://www.rdocumentation.org/packages/base/functions/table) function to build a table of counts of the genres in `movies`. Use the resulting table to create a pie chart with [`boxplot()`](http://www.rdocumentation.org/packages/graphics/functions/pie).

*** =hint
To create `genre_counts`, use `table(movies$genre)`.
