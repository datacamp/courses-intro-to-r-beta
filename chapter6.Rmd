...
success_msg("Nice one! This is going fast! Get ready for a challenge!")
```
...
test_instruction(1, {
  test_error()
  test_object("continents_factor")
})
test_instruction(2, {
  test_error()
  test_object("countries_df")
})
test_instruction(3, {
  test_error()
  test_object("countries_df", eq_condition = "equal")
})
test_instruction(4, {
  test_error()
  test_object("countries_df", eq_condition = "equal")
  test_output_contains("str(countries_df)")
})
...
- Add the `pluto` data frame to `planets_df` and assign to `planets_df_ext`.
- Inspect the resulting data frame by printing it.
...
success_msg("Wonderful! What does the resulting data frame look like? Order prevailed! It's about time that you combined everything you've learned on data frames in the final challenge!")
```
...
test_instruction(1, {
  test_error()
  test_object("countries_df_dem")
})
test_instruction(2, {
  test_error()
  test_object("countries_df2")
})
test_instruction(3, {
  test_error()
  test_object("countries_df2")
  test_output_contains("countries_df2[order(countries_df2$population,decreasing=TRUE), ]")
})
test_instruction(4, {
  test_error()
  test_object("countries_df2")
