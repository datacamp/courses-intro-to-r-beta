...
test_output_contains("str(my_super_list)", incorrect_msg = "Don't forget to display the structure of `my_super_list` using the `str()` function.")
...
test_output_contains("str(shining_list)", 
                     incorrect_msg = "Do not forget to inspect the structure of `shining_list` using the `str()` function.")
