...
test_function("colSums", "x", incorrect_msg = "Did you use the `colSums()` function on `all_wars_matrix`?")
...
test_object("average_us_visitors", incorrect_msg = "It looks like `average_us_visitors` does not contain the average of the US visitors.")
test_object("average_non_us_visitors", incorrect_msg = "It looks like `average_non_us_visitors` does not contain the average of the US visitors.")
