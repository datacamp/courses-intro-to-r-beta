...
# Fix untill testwhat gets updated again
# TODO: Fix in testwhat
test_object("star_wars_ext", eval = FALSE)
test_what(
  expect_equal(
    dim(get("star_wars_ext", get_solution_env())), 
    dim(get("star_wars_ext", .GlobalEnv))),
  feedback_msg = 
    paste("Be sure to use the the function `cbind()` with 2 arguments: `star_wars_matrix`",
          "and `world_wide_vector`. You should end up with a matrix",
          "of the correct dimensions: 3 rows and 3 columns."))
...
test_what(
  ...
  feedback_msg = 
    paste("Be sure to use the the function `rbind()` with 2 arguments: `star_wars_matrix`",
          "and `star_wars_matrix2`. You should end up with a matrix",
          "of the correct dimensions: 6 rows and 2 columns."))
...
test_instruction(3, {
  ...
  test_object("view_count_2")
  test_or(
    test_an_object("total_views_loud"),
