...
test_instruction(1, {
  test_error()
  test_an_object('theater', undefined_msg = 'theater not found')
})
test_instruction(2, {
  test_error()
  test_an_object('row_scores', undefined_msg = 'row_scores not found')
})
test_instruction(3, {
  test_error()
  test_an_object('scores', undefined_msg = 'scores not found')
})
test_instruction(4, {
  test_error()
  test_an_object('scores', undefined_msg = 'scores not correct', eq_condition = "equal")
})
test_instruction(5, {
  test_error()
  test_an_object('scores', undefined_msg = 'scores not correct', eq_condition = "equal")
...
test_instruction(1, {
  ...
  test_object("remaining")
})
test_instruction(2, {
  test_error()
  test_object("star_wars_matrix")
  test_object("commission_rates")
  test_object("remaining_tot")
})
test_instruction(3, {
  test_error()
  test_object("star_wars_matrix")
