...
- Use `summary()` to generate a summary of `speed_factor`: automagically, R prints the factor levels in the right order.
...
- The argument `levels` should be equal to `c("Slow", "Fast", "Ultra-fast")`.
...
test_output_contains("summary(speed_factor)", incorrect_msg = "Don't forget to summarise `speed_factor`. Use `summary()`.")
