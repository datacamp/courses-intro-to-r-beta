...
test_instruction(1, {
  ...
  test_that("first instruction", {
    expect_that(exists("fly_class_factor", envir = globalenv(), inherits = FALSE), is_true(), failure_msg = "None")
    expect_true(is.factor(get("fly_class_factor", envir = globalenv(), inherits = FALSE)), failure_msg = "None")
  })
})
test_instruction(2, {
  test_error()
