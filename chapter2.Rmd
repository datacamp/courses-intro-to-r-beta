...
--- type:MultipleChoiceExercise xp:100 skills:1
...
test_instruction(1, {
  ...
  test_or(
    ...
    {
      test_object("roulette_past")
      test_object("poker_past")
      test_output_contains("sum(poker_past) + sum(roulette_past)")
    }
  )
...
test_instruction(2, {
  ...
  test_or(
    ...
    {
      test_object("poker_present")
      test_object("poker_past")
      test_output_contains("poker_present - poker_past")
    }
  )
...
test_instruction(3, {
  ...
  test_or(
    ...
    {
      test_an_object("roulette_past")
      test_an_object("roulette_present")
      test_output_contains("sum(roulette_past) > sum(roulette_present)")
    }
  )
  assign("passed3", get("passed3", get_solution_env()), .GlobalEnv)
})
test_instruction(4, {
  test_error()
  test_object("passed1")
