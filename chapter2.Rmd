...
*** =video_link
```{r,eval=FALSE}
//player.vimeo.com/video/138173904
```

*** =video_stream
```{r,eval=FALSE}
https://player.vimeo.com/external/138173904.hd.mp4?s=30786451cfd2829cf4a9aad81c665652&profile_id=119
```

*** =video_hls
```{r,eval=FALSE}
https://player.vimeo.com/external/138173904.m3u8?p=high,standard,mobile&s=3cd9c5ece89691b44e37cabdcab126c3
```
...
*** =instructions
- Assign the results to `roulette_subset` the roulette results from Tuesday to Friday inclusive by making use of `:`.
...
Try to use logical vectors to perform the comparison.
