...
test_instruction(1, {
  ...
  test_what(expect_true(is.factor(get("fly_class_factor", envir = globalenv(), inherits = FALSE))), feedback = "none")
})
test_instruction(2, {
  test_error()
  test_object("fly_class_factor")
  test_what(expect_equal(levels(get("fly_class_factor", envir = globalenv(), inherits = FALSE)), c("economy", "business", "first")), feedback = "FALSE")
})
test_instruction(3, {
  test_error()
  test_object("fly_class_factor")
